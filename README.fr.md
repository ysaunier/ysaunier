...
|---|---|---|---|
| :satellite: | [**wtch**](https://github.com/ysaunier/wtch) | Application legere en barre systeme pour surveiller vos services cloud. 375+ presets. | Rust, Tauri, Vue |
| :globe_with_meridians: | **ysaunier.dev** | Plateforme personnelle en micro-frontends avec Module Federation. | TypeScript, Vue 3, Hono |
